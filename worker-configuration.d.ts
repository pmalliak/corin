/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b5d00f98c25037335c85329f692e65e)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	RELEASES: R2Bucket;
	COACH_DB: D1Database;
	DISCORD_PUBLIC_KEY: string;
	DEVICE_SESSIONS: DurableObjectNamespace<import("./src/index").DeviceSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeviceSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_PUBLIC_KEY">> {}
}
