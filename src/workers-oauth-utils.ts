 ...
 * - RFC 7591 Â§2: Client metadata URIs must point to valid web resources
 * - RFC 7591 Â§5: Protect users from malicious content (whitelist approach)
 *
...
export function sanitizeUrl(url: string): string {
	...
	// RFC 7591 Â§2: Client metadata URIs must point to valid web pages/resources
	// RFC 7591 Â§5: Protect users from malicious content
...
export async function validateOAuthState(
	...
	// Verify HMAC signature before touching KV â€” rejects forged/injected state values immediately
